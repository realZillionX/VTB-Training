...
from data.puzzle.base import AbstractPuzzleEvaluator  # noqa: E402


def _discover_evaluator_class(puzzle_type: str) -> Type[AbstractPuzzleEvaluator]:
    module_name = f"data.puzzle.{puzzle_type}.evaluator"
...
def main(argv: Optional[Iterator[str]] = None) -> None:
    ...
    metadata_path = args.metadata if args.metadata else (REPO_ROOT / "dataset" / puzzle_type / "data.json")
